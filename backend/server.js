...
// ]
const sensorType = [
    'airSensor', 'temperatureSensor', 'humidity', 'gasSensor', 'emergencySensor',
    'lightSensor', 'motionSensor', 'gasSensor', 'noiseSensor', 'vibrationSensor',
    'waterFlowDetector', 'waterLevelDetector', 'humiditySensor', 'populationSensor'
]
